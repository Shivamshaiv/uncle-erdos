...
def factor(n, limit = 1000):
    '''Factorise an given integer with Lenstra Elliptic Curve Factorisation
    Here the limit argument is optional is the maximum expected factor size.'''
    g = n
    while g == n:
        # Randomized x and y
...
#print(lenstra(459245788321,500))